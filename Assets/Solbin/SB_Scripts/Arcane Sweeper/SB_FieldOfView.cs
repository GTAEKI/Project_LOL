...
public delegate void VisibilityChange(List<Transform> newTargets);

[ExecuteInEditMode]
public class SB_FieldOfView : MonoBehaviour
{
    ...
    //public MeshFilter viewMeshFilter;   // 시야 메시 필터x
    //public bool debug;                  // 디버그 모드
    //Mesh viewMesh;

    //public static event VisibilityChange OnTargetsVisibilityChange;  // 타겟 가시성 변경 이벤트
